...
The program also provides information about failed tests to make debugging easier.

Additional Files

The project uses "document.txt" to store ASCII art displayed by the program.
...
This project was created as part of an educational program and is intended for learning and experimentation.

It is not intended for use in production systems, especially the authentication and password-storage components.
